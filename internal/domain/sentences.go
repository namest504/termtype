...
var Sentences = []string{
	...
	"The US president also suggests Nicolas Maduro's days as the South American country's leader are numbered.",
	...
	"He runs the business with his wife Elisa Ahonpaa-Kim.",
	...
	"And then brands like Lancome and Clinique manufacture their products in Korea and Japan, but then it doesn't make those brands Japanese and Korean.",
	...
	"Worldwide, around $3tn (2.2tn GBP) will be spent on data centres that support AI between now and 2029.",
	...
	"Some of those will be built for Microsoft which earlier this month announced $30bn (22bn GBP) investment in the UK's AI sector.",
